...
- Renamed custom Codex skills to shorter IDs (removed `vibecode-` prefix) across template packs.
- Updated template skill indexes and config examples to use new short names.

### Added

- Added detailed skill usage documentation with per-skill guidance and decision flow:
...
- Added Codex template skill packs under:
  - `templates/.codex/skills`
  - `templates/.agents/skills`
- Added starter Codex config template:
...
[4.1.1]: https://github.com/duck4nh/antigravity-kit/releases/tag/v4.1.1
[4.1.0]: https://github.com/duck4nh/antigravity-kit/releases/tag/v4.1.0
